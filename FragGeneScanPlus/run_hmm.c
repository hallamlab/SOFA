...
int main (int argc, char **argv) {
        ...
        thread_datas = (thread_data*)malloc(sizeof(thread_data) * threadnum);
...
void init_thread_data(thread_data* td){
        ...
        td->output_num_sequences = (unsigned int*)malloc(sizeof(unsigned int) * 2);
        memset(td->output_num_sequences, 0, sizeof(int)*2);
        td->input_num_sequences = (unsigned int*)malloc(sizeof(unsigned int) * 2);
        ...
        td->dna	= (char*)malloc(sizeof(char) * 1500);
        memset(td->dna, 0, sizeof(char) * 1500);
        td->dna1 = (char*)malloc(sizeof(char) * 1500);
        memset(td->dna1, 0, sizeof(char)*1500);
        td->dna_f = (char*)malloc(sizeof(char) * 1500);
        memset(td->dna_f, 0, sizeof(char)*1500);
        td->dna_f1 = (char*)malloc(sizeof(char) * 1500);
        memset(td->dna_f1, 0, sizeof(char)*1500);
        td->protein = (char*)malloc(sizeof(char) * 500);
        memset(td->protein, 0, sizeof(char)*500);
        td->temp_str = (char*)malloc(sizeof(char) * 512);
        memset(td->temp_str, 0, sizeof(char)*512);

        td->insert = (int*)malloc(sizeof(int) * 100);
        td->c_delete =(int*) malloc(sizeof(int) * 100);
        ...
        for (i=0;i<2;i++) {
                ...
                for(j=0;j<MAX_SEQS_PER_BUFFER;j++){
                        td->input_buffer[i][j] = (char*)malloc(STRINGLEN);
                        td->input_head_buffer[i][j] = (char*)malloc(STRINGLEN);
                        td->aa_buffer[i][j] = (char*)malloc(STRINGLEN);
                        td->dna_buffer[i][j] = (char*)malloc(STRINGLEN);
                        td->output_buffer[i][j] = (char*)malloc(STRINGLEN);
